...
const Nav = () => {
    ...
    return (
        ...
        <div>
            <nav id="header" className="w-full z-30 top-10 py-1 bg-white shadow-lg border-b border-green-400 ">
                <div className="w-full flex items-center justify-between mt-0 px-6 py-2">
                        ...
                        <nav>
                            <ul className="md:flex items-center justify-between text-base text-green-800 pt-4 md:pt-0">
                              <li><a className="inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2 " href="/" >Home</a></li>
                                <li><a className="inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2" href="/symptom">Cat-symptom</a></li>
                    ...
                    <div className="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
                        <div className="auth flex items-center w-full md:w-full">
                            ...
                            <button className="bg-green-600 text-gray-200  p-2 rounded  hover:bg-green-500 hover:text-gray-100">Sign up</button>
                        </div>
                    </div>
                </div>
            </nav>
